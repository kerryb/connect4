...
defmodule Connect4.Auth.Schema.PlayerToken do
  @moduledoc """
  Session token functionality, generated by `mix phx.gen.auth`.
  """
  ...
  schema "players_tokens" do
    ...
    belongs_to(:player, Connect4.Auth.Schema.Player)
  ...
  """
  def verify_change_email_token_query(token, "change:" <> _val = context) do
    case Base.url_decode64(token, padding: false) do
      {:ok, decoded_token} ->
        hashed_token = :crypto.hash(@hash_algorithm, decoded_token)
  ...
  def player_and_contexts_query(player, [_h | _t] = contexts) do
